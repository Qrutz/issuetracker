                    ...
                    <main className='flex items-center justify-between'>
                        <section className="flex items-center space-x-8">
                            <div className="flex items-center space-x-2 ml-8 h-20 w-36 flex-initial">
                                <Link to="/" className=" text-3xl  font-bold text-gray-200 capitalize tracking-wider cursor-pointer">EasyFlow</Link>
                            </div>
                            <div className="lg:block hidden flex-initial">
                                <ul className='flex items-center space-x-5'>
                                    ...
                                    <li className='cursor-pointer text-gray-200 hover:text-gray-300 text-md capitalize'>
                                        <Link to='myTasks' className='mr-3 text-sm hover:border-b-2 px-2.5 py-1.5 text-gray-200 cursor-pointer'>My Tickets</Link>
                                    </li>
                                    <li className='cursor-pointer text-gray-200 hover:text-gray-300 text-md capitalize'>
