  ...
  return (
    <div> 
            <nav className=' h-20 bg-slate-50 border-gray-200 px-2 flex justify-between   '>
                 ...
                 {toggle ? <button onClick={() => setToggle(!toggle)} className='self-center mr-9 font-semibold'>Close</button> : <button onClick={() => setToggle(!toggle)} className='self-center mr-9 font-semibold'>Add an issue</button>}
